...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-50 flex items-center justify-between">
            <h2 class="text-xl font-bold text-slate-900 tracking-tight leading-normal uppercase tracking-tighter">Thông tin tài khoản mới</h2>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    @error('name') <span class="text-[11px] font-bold text-red-500 ml-1">{{ $message }}</span> @enderror
                </div>
                ...
                <!-- Password -->
                <div class="space-y-2 uppercase tracking-tighter">
                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest tracking-tighter ml-1">Mật khẩu đăng nhập</label>
            ...
            <div class="pt-6 border-t border-gray-50 flex items-center justify-end gap-3 uppercase tracking-tighter">
                <button type="reset" class="px-8 py-3 bg-slate-100 text-slate-500 rounded-2xl font-bold text-sm hover:bg-slate-200 active:scale-95 transition-all">
                    Làm mới form
                </button>
                <button type="submit" class="px-8 py-3 bg-blue-600 text-white rounded-2xl font-bold text-sm shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:scale-105 active:scale-95 transition-all tracking-widest uppercase">
                    Xác nhận thêm mới
                </button>
            </div>
        </form>
